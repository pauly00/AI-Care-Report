...
class VisitConditionCheckPage extends StatelessWidget {
  const VisitConditionCheckPage({super.key});

  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider<VisitPolicyViewModel>(
      create: (_) => VisitPolicyViewModel(),
      builder: (context, child) => const _VisitConditionCheckBody(),
    );
  }
}

class _VisitConditionCheckBody extends StatefulWidget {
  const _VisitConditionCheckBody();

  @override
  State<_VisitConditionCheckBody> createState() => _VisitConditionCheckBodyState();
}

class _VisitConditionCheckBodyState extends State<_VisitConditionCheckBody> {
      ...
      bottomNavigationBar: Padding(
        ...
        child: BottomOneButton(
          ...
          onButtonTap: () async {
            ...
            final welfareList =
                await vmPolicy.fetchWelfarePolicies(reportId);
            if (!mounted) return;
