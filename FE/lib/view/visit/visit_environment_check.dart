...
import 'package:safe_hi/view/visit/visit_condition_check.dart';
import 'package:safe_hi/widget/appbar/default_back_appbar.dart';
import 'package:safe_hi/widget/button/bottom_one_btn.dart';
import 'package:safe_hi/util/responsive.dart';

class VisitEnvironmentCheckPage extends StatefulWidget {
  const VisitEnvironmentCheckPage({super.key});

  @override
  VisitEnvironmentCheckPageState createState() => VisitEnvironmentCheckPageState();
}

class VisitEnvironmentCheckPageState extends State<VisitEnvironmentCheckPage> {
      ...
      bottomNavigationBar: Padding(
        ...
        child: BottomOneButton(
          ...
          onButtonTap: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => const VisitConditionCheckPage()),
            );
          },
        ),
      ),
