...
import 'package:safe_hi/view/report/report_policy_recommend.dart';
...
class ReportRiskInfoPage extends StatefulWidget {
  const ReportRiskInfoPage({super.key});

  @override
  State<ReportRiskInfoPage> createState() => _ReportRiskInfoPageState();
}

class _ReportRiskInfoPageState extends State<ReportRiskInfoPage> {
  // 공통 색상
  ...
  final int _cntInterest = 3;
  final int _cntCaution  = 4;
  final int _cntSevere   = 2;

  // LED 이벤트 리스트 더미 데이터 - 추후 API 연동 필요
  final List<_LedEvent> _events = const [
    _LedEvent(round: '1차', date: '2025.08.11', level: _Level.caution),
    _LedEvent(round: '2차', date: '2025.08.16', level: _Level.severe),
    _LedEvent(round: '3차', date: '2025.08.19', level: _Level.severe),
    _LedEvent(round: '4차', date: '2025.08.28', level: _Level.caution),
  ];
      ...
      bottomNavigationBar: Padding(
        ...
        child: BottomTwoButton(
          ...
          onButtonTap2: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (_) => const ReportPolicyRecommendPage()),
            );
          },
        ),
      ),
          ...
          child: SizedBox(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  flex: 1,
                  child: Container(color: const Color(0xFFF6B81A)),
                ),
                Expanded(
                  flex: 1,
                  child: Container(color: _primaryRed),
                ),
              ],
            ),
          ),
  ...
  static const Map<_Level, Color> _chipBg = {
    _Level.interest: Color(0xFFE0E0E0),
    _Level.caution: Color(0xFFF6B81A),
    _Level.severe: _primaryRed,
  };
