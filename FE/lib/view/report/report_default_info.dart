...
import 'package:safe_hi/view/report/report_summary_review.dart';
...
class ReportDefaultInfoPage extends StatefulWidget {
  const ReportDefaultInfoPage({
    super.key,
  ...
  @override
  State<ReportDefaultInfoPage> createState() => _ReportDefaultInfoPageState();
}

class _ReportDefaultInfoPageState extends State<ReportDefaultInfoPage> {
                      ...
                      Column(
                        ...
                        children: [
                          elderProfileSection(
                            ...
                            address: report.address1,
                            phone: report.phone,
                            birth: '1955.04.02',
                            gender: report.gender == 1 ? '남' : '여',
                          ),
                          managerProfileSection(
                            managerName: '$username 돌봄 매니저',
                            affiliation: '제주 이도 2동 담당',
                            phone: userVM.user?.phoneNumber ?? '010-1234-5678',
                          ),
                          careCountSection(
                            visitCount: 2,
                            callCount: 2,
            ...
            Navigator.push(
              ...
              MaterialPageRoute(
                builder: (_) => ChangeNotifierProvider(
                  ...
                  child: const ReportSummaryReviewPage(),
                ),
              ),
            );
          },
