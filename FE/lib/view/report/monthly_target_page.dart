...
class _MonthlyTargetPageState extends State<MonthlyTargetPage> {
  ...
  List<MonthlyReportItem> items = [
    const MonthlyReportItem(year: 2025, month: 9, generated: false),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: MonthlyTarget(
        ...
        onSeeTargets: () => Navigator.of(context).maybePop(),
        ...
        onViewReport: () {
          ...
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (_) => ReportDefaultInfoPage(
