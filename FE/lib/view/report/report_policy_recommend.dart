...
import 'package:safe_hi/view/report/report_submit_complete.dart';
...
class ReportPolicyRecommendPage extends StatefulWidget {
  const ReportPolicyRecommendPage({super.key});

  @override
  State<ReportPolicyRecommendPage> createState() => _ReportPolicyRecommendPageState();
}

class _ReportPolicyRecommendPageState extends State<ReportPolicyRecommendPage> {
                              ...
                              Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    const SizedBox(height: 6),
                                    _bullet(
                                      '• 최근 상담 내용에서 외출 어려움과 의료 접근성 문제 반복 언급됨',
                                      rs,
                                    ),
      ...
      bottomNavigationBar: Padding(
        ...
        child: BottomTwoButton(
          ...
          onButtonTap2: () async {
            ...
            Navigator.push(
              context,
              MaterialPageRoute(builder: (_) => const ReportSubmitCompletePage()),
            );
          },
        ),
      ),
