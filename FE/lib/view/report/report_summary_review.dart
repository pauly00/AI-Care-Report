...
import 'package:safe_hi/view/report/report_risk_info.dart';
...
class ReportSummaryReviewPage extends StatefulWidget {
  const ReportSummaryReviewPage({super.key});

  @override
  State<ReportSummaryReviewPage> createState() => _ReportSummaryReviewPageState();
}

class _ReportSummaryReviewPageState extends State<ReportSummaryReviewPage> {
            ...
            Navigator.push(
              ...
              MaterialPageRoute(
                builder: (_) => ChangeNotifierProvider(
                  ...
                  child: const ReportRiskInfoPage(),
                ),
              ),
            );
          },
